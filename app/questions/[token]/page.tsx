...
export default async function QuestionStatusPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  if (!question) return <main className="public-page"><section className="status-card"><h1>確認用URLが見つかりません</h1><p>URLを確認して、もう一度開いてください。</p><Link className="button primary" href="/">ホームへ戻る</Link></section></main>;
